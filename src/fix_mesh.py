...
Taken from: https://github.com/PyMesh/PyMesh/blob/master/scripts/fix_mesh.py
Modified for custom usage
"""
...
def fix_mesh_target_length(mesh, target_len):
    count = 0;
...
def fix_mesh(mesh, detail="normal"):
    ...
    return fix_mesh_target_length(mesh, target_len);
